    ...
    <body>
        ...
        <nav class="sidebar">
            <ul>
                ...
                <li><a href="./doacao.html"><span>Minhas doações</span></a></li>
                <li><a href="./perfil.php"><span>Perfil</span></a></li>
                <li><a href="./ondedoar.html" target="_blank">Saiba onde doar</a></li>
                <li><a href="../sites/conheFinanceiro.html" target="_blank">Conhecimento Financeiro</a></li>
                <li><a href="../sites/sobreNos.html" target="_blank">Sobre nós</a></li>
            </ul>
        </nav>
