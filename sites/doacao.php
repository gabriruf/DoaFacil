    ...
    <body>
            ...
            <section class="grid-pedidos">
                ...
                <article class="card">
                    <div class="card-image">
                        <img src="../img/cestaBasica.jpg" alt="Cesta básica">
                    </div>
                ...
                <article class="card">
                    <div class="card-image">
                        <img src="../img/ropaFrio.jpg" alt="Roupas de inverno">
                    </div>
                    <div class="card-content">
                ...
                <article class="card">
                    <div class="card-image">
                        <img src="../img/itensHigiene.jpg" alt="Itens de higiene">
                    </div>
                    <div class="card-content">
        ...
        <nav class="sidebar">
            <ul>
                ...
                <li><a href="../sites/conheFinanceiro.html">Conhecimento Financeiro</a></li>
                <li><a href="../sites/sobreNos.html">Sobre nós</a></li>
            </ul>
        </nav>
